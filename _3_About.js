...
//button er text ke as a state use korchi
  ...
  return (
    <div className='container' style={myStyle}>
     <h1 className='my-2'>About us</h1>
         {/* BOOTSTRAP=>COMPONENTS=>ACCORDIAN(copy korechi) */}
            ...
            <h2 className="accordion-header">
                ...
                <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body" style={myStyle}>
                        ...
                        appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or
                        overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.
